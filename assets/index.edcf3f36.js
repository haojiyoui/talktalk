...
`,{type:"hashtag",text:"#\u767D\u5AD6\u673A\u573A"},""]}];var at={about:et,data:nt,name:it,type:pt,id:ot,messages:st};const lt={name:"App",components:{TelegramCard:tt},data(){return{telegram:at,isRouteAlive:!0,mobile:window.innerWidth<720,avatarImg:"https://cdn.jsdelivr.net/gh/anran-world/contact@master/\u6559\u7A0B\u5B58\u56FE/Anran\u6742\u8D27\u94FA - 24\u5C0F\u65F6\u5168\u5929\u670D\u52A1.r01wc7o6jmo.png",loading:!1}},created(){},mounted(){},provide(){return{reload:this.reload}},methods:{openLink(e){window.open(e)}},destroyed(){}},ht={key:0},dt={class:"avatar"},mt=["src"],rt=n("div",{class:"slogon"},[n("img",{src:"https://cdn.jsdelivr.net/gh/anran-world/contact@master/\u6559\u7A0B\u5B58\u56FE/6f8cc2516cfe4ef4b9aa0c534c739979.5ya6fbnzcog0.PNG"})],-1),xt=b("\u6742\u8D27\u94FA"),ct=b("\u5F71\u89C6\u4F1A\u5458\u6279\u53D1"),yt=b("\u7535\u62A5\u9891\u9053"),gt=n("div",{class:"arrow-animation animated fadeOutUp infinite"},[n("i",{class:"iconfont icon-arrow-up-1-icon"})],-1),wt={class:"bookmark"},kt=n("div",{class:"footer"},null,-1);function ft(e,i,d,o,t,p){const l=c("el-button"),r=c("telegram-card"),f=c("el-tab-pane"),s=c("el-tabs"),u=N("loading");return t.isRouteAlive?(a(),h("div",ht,[n("div",{class:M(t.mobile?"search-section-m":"search-section-pc")},[n("div",dt,[n("img",{src:t.avatarImg,class:"avatar-img"},null,8,mt),rt,m(l,{round:"",onClick:i[0]||(i[0]=x=>p.openLink("http://anranshop.ga/"))},{default:w(()=>[xt]),_:1}),m(l,{round:"",onClick:i[1]||(i[1]=x=>p.openLink("http://feizhu.fk6666.cn/"))},{default:w(()=>[ct]),_:1}),m(l,{round:"",onClick:i[2]||(i[2]=x=>p.openLink("https://t.me/anranbp"))},{default:w(()=>[yt]),_:1})]),gt,z(n("div",wt,[m(s,{class:"bookmark-tabs"},{default:w(()=>[(a(!0),h(y,null,I(t.telegram.data,(x,v)=>(a(),G(f,{key:v,class:"bookmark-tabs-tab",label:x.name},{default:w(()=>[m(r,{td:t.telegram.messages,tg:x.id,ab:t.telegram.about},null,8,["td","tg","ab"])]),_:2},1032,["label"]))),128))]),_:1})],512),[[u,t.loading]]),kt],2)])):g("",!0)}var ut=T(lt,[["render",ft]]);const j=B(ut);j.use(Z);j.mount("#app");
