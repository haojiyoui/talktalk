import{a as _,r,o as a,c as x,b,F as d,d as n,e as y,t as g,f as w,g as N,h as z,w as k,i as T,n as M,j as f,k as B,l as G,m as Z}from"./vendor.3f339e37.js";const L=function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const p of t)if(p.type==="childList")for(const o of p.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function h(t){const p={};return t.integrity&&(p.integrity=t.integrity),t.referrerpolicy&&(p.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?p.credentials="include":t.crossorigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function s(t){if(t.ep)return;t.ep=!0;const p=h(t);fetch(t.href,p)}};L();const D="http://49.233.56.61",S=3e3,j=_.create({baseURL:D,timeout:S});j.interceptors.request.use(e=>(e.headers["Content-Type"]="application/json",e),e=>e);j.interceptors.response.use(e=>e.data,e=>e);var v=(e,i)=>{for(const[h,s]of i)e[h]=s;return e};const J={props:{td:Array,tg:Array,ab:Object},inject:["reload"],data(){return{dataSource:[]}},computed:{},created(){const e=[],i=[];this.td.map(s=>s.id).forEach((s,t)=>this.tg.forEach(p=>s===p&&i.push(t))),i.sort((s,t)=>t-s).forEach(s=>e.push(this.td[s])),this.dataSource=Object.assign([],e)},methods:{parseTgText(e){e&&e.text.forEach(i=>{console.log("[ item ] ->",typeof i)})}}},F={style:{"font-size":"30px",padding:"0 0 10px",color:"#8e8e8e"}},Y={class:"tgme_widget_message js-widget_message"},O={class:"tgme_widget_message_user"},q=["href"],P={class:"tgme_widget_message_user_photo bgcolor2","data-content":"\u6211"},Q=["src"],V={class:"tgme_widget_message_bubble"},E=N('<a class="tgme_widget_message_bubble_logo" data-v-08605b92></a><i class="tgme_widget_message_bubble_tail" data-v-08605b92><svg class="bubble_icon" width="9px" height="20px" viewBox="0 0 9 20" data-v-08605b92><g fill="none" data-v-08605b92><path class="background" fill="#ffffff" d="M8,1 L9,1 L9,20 L8,20 L8,18 C7.807,15.161 7.124,12.233 5.950,9.218 C5.046,6.893 3.504,4.733 1.325,2.738 L1.325,2.738 C0.917,2.365 0.89,1.732 1.263,1.325 C1.452,1.118 1.72,1 2,1 L8,1 Z" data-v-08605b92></path><path class="border_1x" fill="#d7e3ec" d="M9,1 L2,1 C1.72,1 1.452,1.118 1.263,1.325 C0.89,1.732 0.917,2.365 1.325,2.738 C3.504,4.733 5.046,6.893 5.95,9.218 C7.124,12.233 7.807,15.161 8,18 L8,20 L9,20 L9,1 Z M2,0 L9,0 L9,20 L7,20 L7,20 L7.002,18.068 C6.816,15.333 6.156,12.504 5.018,9.58 C4.172,7.406 2.72,5.371 0.649,3.475 C-0.165,2.729 -0.221,1.464 0.525,0.649 C0.904,0.236 1.439,0 2,0 Z" data-v-08605b92></path><path class="border_2x" d="M9,1 L2,1 C1.72,1 1.452,1.118 1.263,1.325 C0.89,1.732 0.917,2.365 1.325,2.738 C3.504,4.733 5.046,6.893 5.95,9.218 C7.124,12.233 7.807,15.161 8,18 L8,20 L9,20 L9,1 Z M2,0.5 L9,0.5 L9,20 L7.5,20 L7.5,20 L7.501,18.034 C7.312,15.247 6.64,12.369 5.484,9.399 C4.609,7.15 3.112,5.052 0.987,3.106 C0.376,2.547 0.334,1.598 0.894,0.987 C1.178,0.677 1.579,0.5 2,0.5 Z" data-v-08605b92></path><path class="border_3x" d="M9,1 L2,1 C1.72,1 1.452,1.118 1.263,1.325 C0.89,1.732 0.917,2.365 1.325,2.738 C3.504,4.733 5.046,6.893 5.95,9.218 C7.124,12.233 7.807,15.161 8,18 L8,20 L9,20 L9,1 Z M2,0.667 L9,0.667 L9,20 L7.667,20 L7.667,20 L7.668,18.023 C7.477,15.218 6.802,12.324 5.64,9.338 C4.755,7.064 3.243,4.946 1.1,2.983 C0.557,2.486 0.52,1.643 1.017,1.1 C1.269,0.824 1.626,0.667 2,0.667 Z" data-v-08605b92></path></g></svg></i><div class="tgme_widget_message_author accent_color" data-v-08605b92><a class="tgme_widget_message_owner_name" href="https://t.me/anranbp" data-v-08605b92><span dir="auto" data-v-08605b92>\u6211\u7231\u767D\u5AD6</span></a></div>',3),K={class:"tgme_widget_message_text js-message_text",dir:"auto",style:{"text-align":"left","white-space":"break-spaces"}},U={key:0},H=["href"],W=["href"],X={class:"tgme_widget_message_footer js-message_footer"},R=["href"];function $(e,i,h,s,t,p){const o=r("el-divider");return a(!0),x(d,null,b(t.dataSource,(m,u)=>(a(),x("div",{class:"body_widget_post card",key:u},[n("div",F,[y(o,{direction:"vertical"}),n("span",null,g(m.id),1),y(o,{direction:"vertical"})]),n("div",Y,[n("div",O,[n("a",{href:h.ab.url},[n("i",P,[n("img",{src:h.ab.avatar},null,8,Q)])],8,q)])]),n("div",V,[E,n("div",K,[(a(!0),x(d,null,b(m.text,(l,I)=>(a(),x(d,{key:I},[typeof l=="string"?(a(),x("span",U,g(l),1)):w("",!0),typeof l=="object"?(a(),x(d,{key:1},[l.type==="text_link"?(a(),x("a",{key:0,href:l.href,target:"_blank"},g(l.text),9,H)):w("",!0),l.type==="link"?(a(),x("a",{key:1,href:l.text,target:"_blank"},g(l.text),9,W)):w("",!0)],64)):w("",!0)],64))),128))]),n("div",X,[n("a",{href:`${h.ab.url}/${m.id}`,class:"button_link",target:"_blank"}," \u5728TG\u4E2D\u67E5\u770B\u8BE5\u6761\u4FE1\u606F ",8,R)])])]))),128)}var tt=v(J,[["render",$],["__scopeId","data-v-08605b92"]]);const et={name:"\u6211\u7231\u767D\u5AD6",url:"https://t.me/anranbp",avatar:"https://mmbiz.qpic.cn/mmbiz_png/Uafc0WX1HdjMXuHIYib2EDeI1xgklKQqkmlic1mtZ4gPt0ou8WaX50IBiag0JxHjB0Ugj24BhOnxQ2WS5FZTLskRg/0?wx_fmt=png"},nt=[{name:"\u767D\u5AD6\u673A\u573A",id:[29,34,35,39,43,44,49,50,52,56,57,62,69,74,82,83,95,99,101,120,123,132,135,142,147,164,171,180,191,194,203,205,216,217,220,284,294,302,308,311,319]},{name:"\u767D\u5AD6\u7F51\u7AD9",id:[37,41,53,55,58,61,63,89,90,153,157,165,167,170,173,174,175,190,196,200,201,202,209,210,211,212,215,217,291,293,299,305,309,310,313,316]},{name:"\u767D\u5AD6\u7EBF\u62A5",id:[72,76,78,80,84,85,86,98,107,109,113,114,116,121,127,129,137,144,161,166,169,176,186,188,189,195,199,206,217,219,298,314]},{name:"\u767D\u5AD6\u8BA2\u9605",id:[40,60,81,96,97,111,125,141,159,162,179,182,197,198,217,292,297,300,304,306]},{name:"\u767D\u5AD6TG\u4EE3\u7406",id:[64,79,147,148,149,150,115,139,217]},{name:"\u767D\u5AD6\u8D44\u6E90",id:[36,38,87,92,122,151,172,184,185,204,213,217,285,290,296]},{name:"\u767D\u5AD6\u6559\u7A0B",id:[65,66,67,77,88,91,94,100,108,110,131,145,217]},{name:"\u767D\u5AD6\u4F1A\u5458\u8D26\u53F7",id:[68,70,67,217,289]}],it="\u6211\u7231\u767D\u5AD6",pt="public_channel",st=1504326588,lt=[{id:1,type:"service",actor:"\u6211\u7231\u767D\u5AD6",actor_id:"channel1504326588",action:"create_channel",title:"\u6211\u7231\u767D\u5AD6",text:""},{id:2,type:"service",actor:"\u6211\u7231\u767D\u5AD6",actor_id:"channel1504326588",action:"edit_group_photo",text:""},{id:29,type:"message",text:[`\u673A\u573A:\u767D\u6708\u5149
...
`,{type:"hashtag",text:"#\u767D\u5AD6\u673A\u573A"},""]},{id:284,text:[`\u673A\u573A\u63A8\u8350

\u673A\u573A\u{1F4A8}\uFF1APikap

\u5730\u5740\u{1F680}\uFF1A`,{text:"https://pikap.me/"},`

\u7279\u8272\u2728\uFF1A\u9001365\u5929\u8BD5\u7528

\u8BF4\u660E\u26A1\uFE0F\uFF1A\u6240\u53D1\u673A\u573A\u5747\u65E0aff\uFF0C\u4EC5\u4E3A\u767D\u5AD6\u4F7F\u7528\uFF0C\u7ED9\u5927\u5BB6\u591A\u4E00\u4E2A\u9009\u62E9\uFF0C\u5982\u8981\u4E0A\u8F66\uFF0C\u8BF7\u9009\u62E9\u6700\u4F4E\u65F6\u957F\u7684\u3002

`,{text:"#\u767D\u5AD6\u673A\u573A"},""]},{id:285,text:["Clash\uFF1A",{text:"https://suo.yt/XZL9oaO"},""]},{id:288,text:[`\u6821\u62DB\u6C61\u70B9\u516C\u53F8\u8BB0\u5F55

`,{text:"https://github.com/ShameCom/ShameCom"},""]},{id:289,text:[`\u{1F34E}\u7F8E\u533A\u5E10\u53F7

\u767B\u5F55\u9009\u62E9\uFF1A\u5176\u4ED6\u9009\u9879\uFF5E\u4E0D\u5347\u7EA7\uFF5E

`,{text:"\u8D26\u53F7\uFF1Amojgviwrioih@icloud.com"},`

\u5BC6\u7801\uFF1AAa112112`]},{id:290,text:[`\u5F02\u661F\u707E\u53D8\u7B2C\u4E8C\u5B63\u66F4\u65B0\u81F34\u96C6\u963F\u91CC\u8D44\u6E90
`,{text:"https://www.aliyundrive.com/s/bB7P1oJvDXL"},""]},{id:291,text:[`\u6781\u5154\u56FE\u5E8A

\u4E0D\u7528\u6CE8\u518C\uFF0C\u5B8C\u5168\u533F\u540D\uFF0C\u53EF\u4E34\u65F6\u7528\uFF5E

`,{text:"https://pic.jitudisk.com/"},""]},{id:292,text:["\u8BA2\u9605\uFF1A",{text:"https://v1.mk/DpUMjR9"},""]},{id:293,text:[`\u8282\u70B9\u8BA2\u9605\u5728\u7EBF\u6D4B\u901F\u7F51\u7AD9

`,{text:"speed.june628.ml:7777"},`
\u9738\u6C14

`,{text:"hkst.666138.xyz"},`
\u65E0\u540D
...
\u5730\u5740\u{1F680}\uFF1A`,{text:"https://sspanel.oracleusa.ml/"},`

\u7279\u8272\u2728\uFF1A\u9001\u7684\u5957\u9910\u65F6\u95F4\u957F\u3001\u91CF\u5927

\u8BF4\u660E\u26A1\uFE0F\uFF1A\u6240\u53D1\u673A\u573A\u5747\u65E0aff\uFF0C\u4EC5\u4E3A\u767D\u5AD6\u4F7F\u7528\uFF0C\u7ED9\u5927\u5BB6\u591A\u4E00\u4E2A\u9009\u62E9\uFF0C\u5982\u8981\u4E0A\u8F66\uFF0C\u8BF7\u9009\u62E9\u6700\u4F4E\u65F6\u957F\u7684\u3002

`,{text:"#\u767D\u5AD6\u673A\u573A"},""]},{id:296,text:["\u300C\u5F02\u661F\u707E\u53D8.\u7B2C\u4E8C\u5B63.\u5B98\u65B9\u4E2D\u5B57...022.HD1080P.X264.AAC-YYDS\u300Dhttps://",{text:"www.aliyundrive.com/s/bB7P1oJvDXL"},""]},{id:297,text:["V2\u8BA2\u9605\uFF1A",{text:"https://445600.ml/yunbaitechnodes"},""]},{id:298,text:[`\u5F00\u53D1\u8005\u5728ClashforWindows\u4E2D\u53D1\u73B0\u4E00\u4E2A\u9AD8\u5A01\u80C1\u6F0F\u6D1E
...
\u66F4\u65B0\u5730\u5740\uFF1A`,{text:"https://github.com/Fndroid/clashforwindows_pkg/releases/tag/0.19.10"},""]},{id:299,file:"(Filenotincluded.Changedataexportingsettingstodownload.)",thumbnail:"(Filenotincluded.Changedataexportingsettingstodownload.)",mime_type:"image/png",text:"\u96C6\u5408telegram\u5DF2\u77E5\u7684\u9650\u5236"},{id:300,text:`\u8DD1\u6EE1\u5E26\u5BBD\u3002\u3002
...
\u5730\u5740\u{1F680}\uFF1A`,{text:"https://www.ckcloud.xyz/"},`

\u7279\u8272\u2728\uFF1A\u65E0\u9700\u90AE\u7BB1\u9A8C\u8BC1\uFF0C\u901F\u5EA6\u3001\u5EF6\u8FDF\u5747\u4E0D\u9519

\u8BF4\u660E\u26A1\uFE0F\uFF1A\u6240\u53D1\u673A\u573A\u5747\u65E0aff\uFF0C\u4EC5\u4E3A\u767D\u5AD6\u4F7F\u7528\uFF0C\u7ED9\u5927\u5BB6\u591A\u4E00\u4E2A\u9009\u62E9\uFF0C\u5982\u8981\u4E0A\u8F66\uFF0C\u8BF7\u9009\u62E9\u6700\u4F4E\u65F6\u957F\u7684\u3002

`,{text:"#\u767D\u5AD6\u673A\u573A"},""]},{id:304,text:["Clash\uFF1A",{text:"https://suo.yt/9AeXJR3"},""]},{id:305,text:[`\u3010\u4E2A\u4EBA\u4F7F\u7528\u7684\u514D\u8D39\u7535\u5B50\u4E66\u7F51\u7AD9\u3011


\u96C5\u4E66\uFF1A`,{text:"https://yabook.org/"},`
...
`,{text:`\u53F7\u79F0\u5168\u4E16\u754C\u6700\u5927\u7684\u6570\u5B57\u56FE\u4E66\u9986\uFF0C\u4E66\u7C4D\u4F17\u591A\uFF0C\u5404\u7C7B\u4E2D\u56FD\u7981\u4E66\u90FD\u6709\uFF0C\u6CE8\u518C\u524D\u6BCF\u65E5\u53EA\u53EF\u4EE5\u4E0B\u8F7D5\u672C\u4E66\uFF0C\u6CE8\u518C\u540E\u6BCF\u65E510\u672C\uFF0C\u800C\u6350\u8D60\u540E\u53EF\u4EE5\u589E\u52A0\u4E0B\u8F7D\u6570\u91CF\uFF08\u53D6\u51B3\u4E8E\u4F60\u7684\u6350\u8D60\u6570\u91CF\uFF0C\u6211\u6350\u8D60\u4E865\u7F8E\u91D1\u4E0B\u8F7D\u6570\u91CF\u5374\u53EA\u589E\u52A0\u81F3\u6BCF\u65E515\uFF09
`},`Z-Library\u6709\u4ED6\u7684\u5B98\u65B9TELEGRAM\u673A\u5668\u4EBA\uFF0C\u53EF\u4EE5\u7528\u4E8E\u4E0B\u8F7D\u4E66\u7C4D\uFF08\u683C\u5916\u7684\u4E0B\u8F7D\u6570\u91CF\uFF0C\u53EF\u662F\u4E0B\u8F7D\u7684\u6587\u4EF6\u4E0D\u80FD\u592A\u5927\uFF09

\u4E66\u683C\uFF1A`,{text:"https://new.shuge.org/"},`

\u4E2D\u56FD\u6570\u5B57\u53E4\u7C4D\u56FE\u4E66\u9986\uFF0C\u5404\u79CD\u53E4\u7C4D\u6587\u732E\u4E66\u6CD5\u5730\u56FE\u90FD\u6709


LoreFree\uFF1A`,{text:"https://lorefree.com/"},`
...
\u3010\u5176\u4ED6\u4E0D\u5E38\u7528\u7684\u3011
\u718A\u732B\u641C\u5BFB\uFF1A`,{text:"https://xmsoushu.com/#/"},`
\u82E6\u74DC\u4E66\u76D8\uFF1A`,{text:"https://www.kgbook.com/"},`
\u54C8\u4F5B\u56FE\u4E66\u9986\uFF1A`,{text:"https://library.harvard.edu/"},`
\u56FD\u5916\u5B66\u672F\uFF1A`,{text:"https://libgen.li/"},`?
\u82F1\u6587\u7F51\u7AD9\uFF1A`,{text:"https://www.gutenberg.org/"},`
\u82F1\u6587\u7F51\u7AD9\uFF1A`,{text:"https://manybooks.net/"},`
\u82F1\u6587\u7F51\u7AD9\uFF1A`,{text:"https://www.planetebook.com/"},`
\u7A0B\u5E8F\u4E66\u7C4D\uFF1A`,{text:"http://www.banshujiang.cn/"},`
\u56FD\u5185\u7684\u7F51\u7AD9\uFF1A`,{text:"https://www.toplinks.cc/s/"},`
\u867D\u7136\u662F\u82F1\u6587\uFF0C\u53EF\u662F\u53EF\u4EE5\u627E\u534E\u8BED\u4E66\uFF1A`,{text:"https://www.pdfdrive.com/"},`
\u56FD\u7ACB\u53F0\u6E7E\u5927\u5B66\u56FE\u4E66\u9986\uFF1A`,{text:"https://www.lib.ntu.edu.tw/"},""]},{id:306,text:["Clash\uFF1A",{text:"https://mojie.info/api/v1/client/subscribe?token=992f6dad10c4971262f84af8a8673858"},""]},{id:308,text:[`\u673A\u573A\u63A8\u8350

\u673A\u573A\u{1F4A8}\uFF1ALingLing

\u5730\u5740\u{1F680}\uFF1A`,{text:"https://jiji.lingfeiling.tk/"},`

\u7279\u8272\u2728\uFF1A\u5546\u5E97\u8F93\u5165\u4F18\u60E0\u7801\uFF1Alingling\uFF0C\u53EF\u4EE50\u5143\u9886\u53D6\uFF0C\u65E0\u9700\u90AE\u7BB1\u9A8C\u8BC1

\u8BF4\u660E\u26A1\uFE0F\uFF1A\u6240\u53D1\u673A\u573A\u5747\u65E0aff\uFF0C\u4EC5\u4E3A\u767D\u5AD6\u4F7F\u7528\uFF0C\u7ED9\u5927\u5BB6\u591A\u4E00\u4E2A\u9009\u62E9\uFF0C\u5982\u8981\u4E0A\u8F66\uFF0C\u8BF7\u9009\u62E9\u6700\u4F4E\u65F6\u957F\u7684\u3002

`,{text:"#\u767D\u5AD6\u673A\u573A"},""]},{id:309,text:[`\u5168\u7403\u6700\u5927\u7684\u6570\u5B57\u56FE\u4E66\u9986

\u771F\u6B63\u610F\u4E49\u4E0A\u7684\u7F51\u7EDC\u56FE\u4E66\u9986\uFF0C\u771F\u7684\u6570\u4E0D\u6E05\u6709\u591A\u5C11\uFF0C\u5206\u7C7B\u4E5F\u662F\u6700\u591A\u7684\uFF0C\u4EC0\u4E48\u7C7B\u578B\u90FD\u6709\uFF0C\u5305\u62EC\u9EC4\u8272\u7684\uFF0C\u4E66\u7C4D\u90FD\u53EF\u4EE5\u514D\u8D39\u4E0B\u8F7D\uFF01

`,{text:"https://zh.b-ok.com/"},""]},{id:310,text:[`\u5B89\u5353\u7834\u89E3\u7684\u548C\u514D\u8D39\u7684VPN\uFF0C\u9700\u8981\u7FFB\u5899\u624D\u80FD\u6253\u5F00\uFF5E

`,{text:"https://www.alpacadisk.com/shared/AKYTwnwK5k1fir3V"},""]},{id:311,text:[`\u673A\u573A\u63A8\u8350

\u673A\u573A\u{1F4A8}\uFF1A\u571F\u62E8\u9F20

\u5730\u5740\u{1F680}\uFF1A`,{text:"https://www.tuboshu.site/"},`

\u7279\u8272\u2728\uFF1A\u5546\u5E97\u9886\u53D6\u4F7F\u7528\u5957\u9910

\u8BF4\u660E\u26A1\uFE0F\uFF1A\u6240\u53D1\u673A\u573A\u5747\u65E0aff\uFF0C\u4EC5\u4E3A\u767D\u5AD6\u4F7F\u7528\uFF0C\u7ED9\u5927\u5BB6\u591A\u4E00\u4E2A\u9009\u62E9\uFF0C\u5982\u8981\u4E0A\u8F66\uFF0C\u8BF7\u9009\u62E9\u6700\u4F4E\u65F6\u957F\u7684\u3002

`,{text:"#\u767D\u5AD6\u673A\u573A"},""]},{id:313,text:[`\u65E2\u54C1\u4E91\u540E\u7684\u4E00\u4E9B\u5728\u7EBF\u6D4B\u901F\u5E73\u53F0

`,{text:"http://speedtest.zeroteam.top"},`
`,{text:"http://speed.june628.ml:7777"},`
`,{text:"http://hkst.666138.xyz"},`
`,{text:"http://cs.brink.ga"},`
`,{text:"http://sst.brink.ga"},`

\u6CE8\u610F\u8BA2\u9605\u6CC4\u9732\u98CE\u9669`]},{id:314,text:`3.06\u6700\u65B0\u963F\u91CC\u4E91\u76D8\u798F\u5229\u7801\u{1F447}\u{1F447}
500\u4E2A\u53EF\u53E0\u52A0\u5171600GB

200GB\u5BB9\u91CF100\u4E2A\uFF1AabskoopVEUjc
200GB\u5BB9\u91CF300\u4E2A\uFF1AagdrgggixBjc
200GB\u5BB9\u91CF100\u4E2A\uFF1AagdrgggReOoc`},{id:315,text:`1\u3001\u4F18\u9177\u89C6\u9891APP->\u6211\u7684->\u53F3\u4E0A\u89D2\u626B\u7801\u8FDB\u5165->\u4E0B\u62C9\u9875\u9762\u505A\u4EFB\u52A1->\u6BCF\u5929\u6700\u591A\u53EF\u5F9780\u7535\u529B

2\u3001\u6307\u5B9A\u6570\u91CF\u7535\u529B\u53EF\u5151\u6362\u5BF9\u5E94\u91D1\u989D\u7684\u732B\u8D85\u5361\u6216\u4F18\u9177\u4F1A\u5458`},{id:316,text:[`\u603B\u7ED3\u4E86\u4E0B\u4E00\u4E9B\u5E38\u7528\u514D\u8D39\u7684\u7535\u5B50\u4E66\u7F51\u7AD9\uFF0C\u5206\u4EAB\u7ED9\u5927\u5BB6
...
\u56FD\u5185\u7684\u7F51\u7AD9\uFF1A`,{text:"https://www.toplinks.cc/s/"},`
\u867D\u7136\u662F\u82F1\u6587\uFF0C\u53EF\u662F\u53EF\u4EE5\u627E\u534E\u8BED\u4E66\uFF1A`,{text:"https://www.pdfdrive.com/"},`
\u56FD\u7ACB\u53F0\u6E7E\u5927\u5B66\u56FE\u4E66\u9986\uFF1A`,{text:"https://www.lib.ntu.edu.tw/"},""]},{id:317,text:"\u5206\u4EAB\u4E2A\u514D\u8D39\u9886\u53D6\u4F1A\u5458\u8D26\u53F7\u7684\u5C0F\u7A0B\u5E8F\uFF0C\u5C0F\u7A0B\u5E8F\uFF1A\u5F73\u4E8D\u8BF4\u5C0F\u5C4B"},{id:319,file:"(Filenotincluded.Changedataexportingsettingstodownload.)",mime_type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",text:[`512\u4E2A\u767D\u5AD6\u673A\u573A.xlsx

xlsx\u5BC6\u7801\uFF1A`,{text:"https://url44.ctfile.com/f/30401944-552532704-bca1b0"},`
\uFF08\u8BBF\u95EE\u5BC6\u7801\uFF1A5044\uFF09`]}];var at={about:et,data:nt,name:it,type:pt,id:st,messages:lt};const ot={name:"App",components:{TelegramCard:tt},data(){return{telegram:at,isRouteAlive:!0,mobile:window.innerWidth<720,avatarImg:"https://mmbiz.qpic.cn/mmbiz_png/Uafc0WX1HdjMXuHIYib2EDeI1xgklKQqkmlic1mtZ4gPt0ou8WaX50IBiag0JxHjB0Ugj24BhOnxQ2WS5FZTLskRg/0?wx_fmt=png",loading:!1}},created(){},mounted(){},provide(){return{reload:this.reload}},methods:{openLink(e){window.open(e)}},destroyed(){}},xt={key:0},ht={class:"avatar"},yt=["src"],mt=n("div",{class:"slogon"},[n("img",{src:"https://mmbiz.qpic.cn/mmbiz_png/Uafc0WX1HdjMXuHIYib2EDeI1xgklKQqk38hFVfV94rdOJbMPqTY22xEapkDaiaj6ZpmpQB7Macp1736FhI05B2g/0?wx_fmt=png"})],-1),ct=f("\u6742\u8D27\u94FA"),rt=f("\u4F4E\u4EF7\u5F71\u89C6\u4F1A\u5458"),dt=f("\u7535\u62A5\u9891\u9053"),wt=n("div",{class:"arrow-animation animated fadeOutUp infinite"},[n("i",{class:"iconfont icon-arrow-up-1-icon"})],-1),kt={class:"bookmark"},gt=n("div",{class:"footer"},null,-1);function ut(e,i,h,s,t,p){const o=r("el-button"),m=r("telegram-card"),u=r("el-tab-pane"),l=r("el-tabs"),I=z("loading");return t.isRouteAlive?(a(),x("div",xt,[n("div",{class:M(t.mobile?"search-section-m":"search-section-pc")},[n("div",ht,[n("img",{src:t.avatarImg,class:"avatar-img"},null,8,yt),mt,y(o,{round:"",onClick:i[0]||(i[0]=c=>p.openLink("http://shop.anran1.ga"))},{default:k(()=>[ct]),_:1}),y(o,{round:"",onClick:i[1]||(i[1]=c=>p.openLink("http://feizhu.faka55.xyz/"))},{default:k(()=>[rt]),_:1}),y(o,{round:"",onClick:i[2]||(i[2]=c=>p.openLink("https://t.me/anranbp"))},{default:k(()=>[dt]),_:1})]),wt,T(n("div",kt,[y(l,{class:"bookmark-tabs"},{default:k(()=>[(a(!0),x(d,null,b(t.telegram.data,(c,A)=>(a(),B(u,{key:A,class:"bookmark-tabs-tab",label:c.name},{default:k(()=>[y(m,{td:t.telegram.messages,tg:c.id,ab:t.telegram.about},null,8,["td","tg","ab"])]),_:2},1032,["label"]))),128))]),_:1})],512),[[I,t.loading]]),gt],2)])):w("",!0)}var It=v(ot,[["render",ut]]);const C=G(It);C.use(Z);C.mount("#app");
